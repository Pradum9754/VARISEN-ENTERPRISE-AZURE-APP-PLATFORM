# Exposes the IDs of all Pre-Production Resource Groups for downstream module references.
output "resource_group_ids" {
  value = { for k, rg in azurerm_resource_group.preprod-rgs : k => rg.id }
}

# Exposes the names of all Pre-Production Resource Groups for downstream module references.
